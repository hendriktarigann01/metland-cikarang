      ...
      >
        ...
        >
          <div className="text-center px-6 space-y-10 mt-24">
            ...
            <div className="w-[350px] md:w-full mx-auto">
              <h1 className="font-display font-medium text-4xl md:text-7xl leading-[1.05] text-white tracking-tight">
                {headline}
              </h1>
            </div>
            ...
            <div className="w-[350px] md:w-full md:max-w-2xl mx-auto">
              <p className="text-white/90 text-base md:text-lg mx-auto leading-relaxed">
                {subheadline}
              </p>
            </div>
            ...
            <div className="flex flex-col items-center gap-4">
              <a
                ...
                className="inline-flex items-center gap-2 px-8 py-3.5 font-display font-medium text-sm text-white bg-[#0A0E1866] border border-white rounded-xl hover:bg-white/20 transition-all duration-300"
              >
        ...
        >
          <div className="text-left max-w-2xl">
            <h2 className="font-display font-medium text-3xl md:text-6xl text-white mb-6 leading-tight">
              {slides[0].headline}
            </h2>
